...
import random
import os
from algoritmos.arranjo_estatico import ArranjoEstatico
from calculos.calculo import medir_tempo, memoria_inicio, memoria_fim, memoria_total_consumida, DesvioPadrao, esperar
...
for arquivo in arquivos:
    ...
    for x in casos_piores:
        ...
        arranjo_estatico.buscar_sequencial(x)
    ...
    nome_diretorio = './apuramento/'
    if not os.path.exists(nome_diretorio):
        os.makedirs(nome_diretorio)

    nome_arquivo_csv = os.path.join(nome_diretorio, 'busca_sequencial_arranjo_estatico_nao_ordenado.csv')
