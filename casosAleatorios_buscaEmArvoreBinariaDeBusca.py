...
import random
import os
from algoritmos.arvore_binaria import Node
from calculos.calculo import medir_tempo, get_pid, DesvioPadrao, memoria_fim, memoria_inicio, memoria_total_consumida, esperar
...
for arquivo in arquivos:
    ...
    for x in numeros_aleatorios:
        ...
        esperar(segundos=1)
        del inicio_tempo_aleatorio, inicio_memoria_aleatorio, busca,comparacoes, fim_tempo_aleatorio, fim_memoria_aleatorio
